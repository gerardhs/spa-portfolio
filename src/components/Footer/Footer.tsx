    ...
    <footer className="fixed bottom-0 w-full">
      <div className="p-2 w-full mx-auto max-w-screen-2xl flex items-center justify-between">
        ...
        <ul className="flex flex-wrap items-center text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
          <li>
            <Link to={PATH_CONSTANTS.HOME} className="underline hover:no-underline hover:text-gray-900 m-4">
              {t("footer.labels.home")}
            </Link>
          </li>
          <li>
            <Link to={PATH_CONSTANTS.ABOUT} className="underline hover:no-underline hover:text-gray-900 m-4">
              {t("footer.labels.about")}
            </Link>
          </li>
          <li>
            <Link to={PATH_CONSTANTS.PROJECTS} className="underline hover:no-underline hover:text-gray-900 m-4">
              {t("footer.labels.projects")}
            </Link>
          </li>
          <li>
            <Link to={PATH_CONSTANTS.CONTACT} className="underline hover:no-underline hover:text-gray-900 m-4">
          ...
          <div className="flex items-center gap-6 m-4">
            ...
            <Link to={SOCIALS.LINKEDIN} className="p-1 rounded hover:text-gray-900">
              {/* <!-- Linkedin --> */} 
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
