/*! For license information please see main.ded2c0c4.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      470: function (e, t, n) {
  ...
  (n.m = e),
    ...
    (function () {
      ...
      var o,
        i = function () {
          return (0, a.jsx)("header", { children: (0, a.jsx)(yn, {}) });
        };
      function l(e) {
      ...
      function S() {
        ...
        var C = (w.prototype = g.prototype = Object.create(k));
        function _(e) {
        ...
        var y = {
          ...
          listen: function (e) {
            ...
            return (
              ...
              (d = e),
              function () {
                l.removeEventListener(D, v), (d = null);
              }
            );
          },
      ...
      function W(e, t, n, r) {
        return (
          ...
          e.map(function (e, a) {
            ...
            var u = O({}, e, t(e), { id: i, children: void 0 });
            return (
              (r[i] = u), e.children && (u.children = W(e.children, t, o, r)), u
            );
          })
        );
      }
      function H(e, t, n) {
        void 0 === n && (n = "/");
        var r = ae(("string" === typeof t ? A(t) : t).pathname || "/", n);
        if (null == r) return null;
        var a = V(e);
        !(function (e) {
          e.sort(function (e, t) {
      ...
      function te(e, t) {
        for (
          ...
          o.push({
            ...
            pathnameBase: se(ue([a, c.pathnameBase])),
            route: f,
          }),
        ...
        var c = (function (e, t) {
            ...
            var n = "string" === typeof e ? A(e) : e,
              ...
              u = r
                ...
                : t;
            return { pathname: u, search: ce(o), hash: fe(l) };
          })(a, o),
          f = l && "/" !== l && l.endsWith("/"),
          d = (i || "." === l) && n.endsWith("/");
      ...
      function Pe(e) {
        ...
        var l,
          ...
          b = H(s, e.history.location, c),
          w = null;
        if (null == b) {
          var k = Qe(404, { pathname: e.history.location.pathname }),
            x = Ve(s);
          (b = x.matches), (w = _({}, x.route.id, k));
        }
        var E,
          P,
          L =
        ...
        function le(t, n) {
          ...
          i = n.actionData
            ...
            : u
              ...
              : null;
          var c = n.loaderData
              ? We(R.loaderData, n.loaderData, n.matches || [], n.errors)
              : R.loaderData,
            f = R.blockers;
          f.size > 0 &&
          ...
          if (
            ...
            $ ||
              ...
              (D === o.Push
                ...
                : D === o.Replace && e.history.replace(t, t.state)),
            D === o.Pop)
          ) {
            var h = A.get(R.location.pathname);
            h && h.has(t.pathname)
              ? (d = { currentLocation: R.location, nextLocation: t })
              : A.has(t.pathname) &&
                (d = { currentLocation: t, nextLocation: R.location });
          } else if (I) {
            var v = A.get(R.location.pathname);
            v
              ? v.add(t.pathname)
              : ((v = new Set([t.pathname])), A.set(R.location.pathname, v)),
              (d = { currentLocation: R.location, nextLocation: t });
          }
          ie(
            O({}, n, {
              ...
              navigation: ke,
              revalidation: "idle",
              restoreScrollPosition: lt(t, n.matches || R.matches),
                    ...
                    switch ((t.prev = t.next)) {
                      ...
                      case 3:
                        if (
                          ...
                          (i = Re(d.v7_normalizeFormMethod, !1, a, r)),
                          (l = i.path),
                          (u = i.submission),
                          (s = i.error),
                          (f = R.location),
        ...
        function fe() {
          return (
            (fe = C(
              S().mark(function t(n, r, a) {
                var o, i, u, f, d, p, h, v, m, y, g, b, w, k, x;
                return S().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                      ...
                      case 16:
                        if (
                          ...
                          V ||
                          !Ye(R.location, r) ||
                          (a && a.submission && nt(a.submission.formMethod))
                        ) {
                          t.next = 19;
                          break;
                        }
                        return le(r, { matches: u }), t.abrupt("return");
                      case 19:
                        if (
                          ((P = new AbortController()),
                          (v = Ue(e.history, r, P.signal, a && a.submission)),
                          !a || !a.pendingError)
                        ) {
                          t.next = 25;
                          break;
                        }
                        (y = _({}, He(u).route.id, a.pendingError)),
                          (t.next = 35);
                        break;
                      case 25:
                        if (
                        ...
                        return (
                          (t.next = 28),
                          de(v, r, a.submission, u, { replace: a.replace })
                        );
                      case 28:
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (
                          (void 0 === l && (l = {}),
                          ze(),
                          ie({ navigation: ft(r, a) }),
                          (f = ut(i, r)).route.action || f.route.lazy)
                        ) {
                          e.next = 9;
                          break;
                        }
                        ...
                        break;
                      case 9:
                        return (e.next = 11), je("action", n, f, i, u, t, c);
                      case 11:
                      ...
                      case 19:
                        ...
                        return (
                          (p = He(i, f.route.id)),
                          !0 !== (l && l.replace) && (D = o.Push),
                          e.abrupt("return", {
                            pendingActionData: {},
                            pendingActionError: _({}, p.route.id, s.error),
                          })
                        );
                      case 23:
                        if (!Ge(s)) {
                        ...
                        throw Qe(400, { type: "defer-action" });
                      case 25:
                        return e.abrupt("return", {
                          pendingActionData: _({}, f.route.id, s.data),
                        });
                      case 26:
                      case "end":
                        return e.stop();
        ...
        function ve() {
          return (
            (ve = C(
              S().mark(function t(n, r, a, o, i, u, d, p, h) {
                var v,
                  m,
                  y,
                  g,
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 22:
                        ...
                        return (
                          z.idx >= w.length &&
                            ((D = k[z.idx - w.length].key), J.add(D)),
                          (t.next = 29),
                          be(R, z.result, { replace: d })
                        );
                      case 29:
                        return t.abrupt("return", { shortCircuited: !0 });
                      case 30:
                        return (
                          (M = $e(R, a, w, T, h, k, N, ne)),
                          (j = M.loaderData),
                          (F = M.errors),
                          ...
                          t.abrupt(
                            "return",
                            O(
                              { loaderData: j, errors: F },
                              A ? { fetchers: new Map(R.fetchers) } : {},
                            ),
                          )
                        );
                      case 36:
                ...
                return S().wrap(function (n) {
                  for (;;)
                    switch ((n.prev = n.next)) {
                      case 0:
                        if (
                          (ze(), Z.delete(r), i.route.action || i.route.lazy)
                        ) {
                          n.next = 6;
                          break;
                        }
                      ...
                      case 6:
                        return (
                          ...
                          (m = pt(p, v)),
                          R.fetchers.set(r, m),
                          ie({ fetchers: new Map(R.fetchers) }),
                          (y = new AbortController()),
                          (g = Ue(e.history, o, y.signal, p)),
                          K.set(r, y),
                          (b = Y),
                          (n.next = 16),
                          je("action", g, i, d, u, t, c)
                        );
                      case 16:
                        ...
                        return (
                          K.get(r) === y && K.delete(r), n.abrupt("return")
                        );
                      case 20:
                        if (!te.has(r)) {
                          n.next = 24;
                      ...
                      case 33:
                        return (
                          ...
                          R.fetchers.set(r, x),
                          ie({ fetchers: new Map(R.fetchers) }),
                          n.abrupt("return", be(R, w, { fetcherSubmission: p }))
                        );
                      case 38:
                        if (!Xe(w)) {
                          n.next = 41;
                        ...
                        return De(r, a, w.error), n.abrupt("return");
                      case 41:
                        if (!Ge(w)) {
                          n.next = 43;
                          break;
                      ...
                      case 43:
                        return (
                          ...
                          (C = Ue(e.history, E, y.signal)),
                          (L = l || s),
                          M(
                            (T =
                              "idle" !== R.navigation.state
                                ? H(L, R.navigation.location, c)
                                : R.matches),
                      ...
                      case 65:
                        ...
                        return (
                          ee.idx >= F.length &&
                            ((re = U[ee.idx - F.length].key), J.add(re)),
                          n.abrupt("return", be(R, ee.result))
                        );
                      case 73:
                        (ae = $e(R, R.matches, F, $, void 0, U, W, ne)),
                          (oe = ae.loaderData),
                          (ue = ae.errors),
                          R.fetchers.has(r) &&
                            ((se = ht(w.data)), R.fetchers.set(r, se)),
                          Be(N),
                          "loading" === R.navigation.state && N > G
                            ? (M(D, "Expected pending action"),
                              P && P.abort(),
                              le(R.navigation.location, {
                                matches: T,
                                loaderData: oe,
                                errors: ue,
                                fetchers: new Map(R.fetchers),
                            ...
                            : (ie({
                                errors: ue,
                                loaderData: We(R.loaderData, oe, T, ue),
                                fetchers: new Map(R.fetchers),
                              }),
                              (V = !1));
                      case 77:
                  ...
                  for (;;)
                    switch ((n.prev = n.next)) {
                      case 0:
                        return (
                          (f = R.fetchers.get(r)),
                          (d = dt(s, f ? f.data : void 0)),
                          R.fetchers.set(r, d),
                          ie({ fetchers: new Map(R.fetchers) }),
                          (p = new AbortController()),
                          (h = Ue(e.history, o, p.signal)),
                          K.set(r, p),
                          (v = Y),
                          (n.next = 10),
                          je("loader", h, i, l, u, t, c)
                        );
                      case 10:
                        if (!Ge((m = n.sent))) {
                          n.next = 18;
                        ...
                        return (n.next = 14), ot(m, h.signal, !0);
                      case 14:
                        if (((n.t0 = n.sent), n.t0)) {
                          n.next = 17;
                          break;
                      ...
                      case 33:
                        return J.add(r), (n.next = 36), be(R, m);
                      case 36:
                        return n.abrupt("return");
                      case 37:
                        if (!Xe(m)) {
                        ...
                        return De(r, a, m.error), n.abrupt("return");
                      case 40:
                        M(!Ge(m), "Unhandled fetcher deferred data"),
                          (g = ht(m.data)),
                          R.fetchers.set(r, g),
                          ie({ fetchers: new Map(R.fetchers) });
                      case 44:
        ...
        function Pe() {
          return (
            (Pe = C(
              S().mark(function t(a, i, l) {
                var u, s, f, d, p, h, v, m, y, g, b, w, k, x;
                return S().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (
                          ...
                          (f = u.fetcherSubmission),
                          (d = u.replace),
                          i.revalidate && (V = !0),
                          M(
                            (p = U(a.location, i.location, {
                              _isRedirect: !0,
                            })),
                        ...
                        if (
                          ...
                          i.reloadDocument
                            ? (h = !0)
                            : Ee.test(i.location) &&
                              ((v = e.history.createURL(i.location)),
                              (h =
                                v.origin !== n.location.origin ||
                                null == ae(v.pathname, c))),
                          !h)
                        ) {
                          t.next = 10;
                          break;
                        ...
                        return (
                          d
                            ? n.location.replace(i.location)
                            : n.location.assign(i.location),
                          t.abrupt("return")
                        );
                      case 10:
                        if (
                          ((P = null),
                          (m = !0 === d ? o.Replace : o.Push),
                          (y = a.navigation),
                          (g = y.formMethod),
                          (b = y.formAction),
                          (w = y.formEncType),
                          !s && !f && g && b && w && (s = st(a.navigation)),
                          (k = s || f),
                          !(we.has(i.status) && k && nt(k.formMethod)))
                        ) {
                          t.next = 20;
                          break;
                        }
                        return (
                          (t.next = 18),
                          ce(m, p, {
                            submission: O({}, k, { formAction: i.location }),
        ...
        function ze() {
          var e;
          (V = !0),
            (e = Q).push.apply(e, N(tt())),
            Z.forEach(function (e, t) {
              K.has(t) && (q.push(t), Fe(t));
            });
        }
        function De(e, t, n) {
          var r = He(R.matches, t);
          Me(e),
            ie({ errors: _({}, r.route.id, n), fetchers: new Map(R.fetchers) });
        }
        function Me(e) {
          var t = R.fetchers.get(e);
          !K.has(e) || (t && "loading" === t.state && X.has(e)) || Fe(e),
            Z.delete(e),
            X.delete(e),
            J.delete(e),
            te.delete(e),
        ...
        function Fe(e) {
          var t = K.get(e);
          M(t, "Expected fetch controller: " + e), t.abort(), K.delete(e);
        }
        function Ie(e) {
          var t,
            n = T(e);
          ...
          try {
            for (r.s(); !(t = r.n()).done; ) {
              var a = f(t.value, 2),
                o = a[0];
              if (a[1] < e) {
                var i = R.fetchers.get(o);
                M(i, "Expected fetcher: " + o),
                  "loading" === i.state && (Fe(o), X.delete(o), n.push(o));
              }
            }
          } catch (l) {
            r.e(l);
        ...
        function Ke(e) {
          R.blockers.delete(e), re.delete(e);
        }
        function Ze(e, t) {
          var n = R.blockers.get(e) || Se;
          M(
        ...
        function et(e) {
          ...
          if (0 !== re.size) {
            re.size > 1 &&
              j(!1, "A router only supports one blocker at a time");
        ...
        return (
          (E = {
            ...
            initialize: function () {
              ...
              return R.initialized || ce(o.Pop, R.location), E;
            },
            ...
            enableScrollRestoration: function (e, t, n) {
              if (
                ((v = e), (y = t), (m = n || null), !g && R.navigation === ke)
              ) {
                g = !0;
                var r = lt(R.location, R.matches);
                null != r && ie({ restoreScrollPosition: r });
              }
              return function () {
            ...
            fetch: function (e, t, n, r) {
              ...
              var o = l || s,
                ...
                u = H(o, i, c);
              if (u) {
                var f = Re(d.v7_normalizeFormMethod, !0, i, r),
                  p = f.path,
                  h = f.submission,
                  v = f.error;
                if (v) De(e, t, v);
            ...
            revalidate: function () {
              ze(),
                ...
                "submitting" !== R.navigation.state &&
                  ("idle" !== R.navigation.state
                    ? ce(D || R.historyAction, R.navigation.location, {
                        overrideNavigation: R.navigation,
                      })
                    : ce(R.historyAction, R.location, {
      ...
      function Re(e, t, n, r) {
        if (
          ...
          return { path: n };
        if (r.formMethod && !tt(r.formMethod))
          return { path: n, error: Qe(405, { method: r.formMethod }) };
        var a,
          o,
          i = function () {
            return { path: n, error: Qe(400, { type: "invalid-body" }) };
          },
          l = r.formMethod || "get",
        ...
        var h = A(n);
        return (
          t && h.search && lt(h.search) && a.append("index", ""),
          (h.search = "?" + a),
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      ...
                      return e.abrupt("return");
                    case 7:
                      for (l in (M((o = r[t.id]), "No route found in manifest"),
                      (i = {}),
                      a))
                        (u = o[l]),
                          j(
                          ...
                          s || $.has(l) || (i[l] = a[l]);
                      Object.assign(o, i),
                        Object.assign(o, O({}, n(o), { lazy: void 0 }));
                    case 13:
                    case "end":
                      return e.stop();
                  }
      ...
      function Fe() {
        return (
          (Fe = C(
            S().mark(function e(t, n, r, a, o, i, l, u) {
              var s, c, f, d, p, h, v, m, y, g, b, w, k, x, E, C, _, P, L;
              return S().wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 11:
                        ...
                        break;
                      case 14:
                        return (e.next = 16), De(r.route, i, o);
                      case 16:
                        if (!(p = r.route[t])) {
                          e.next = 23;
                          break;
                      ...
                      case 32:
                        ...
                        throw (
                          ((g = new URL(n.url)),
                          Qe(404, { pathname: g.pathname + g.search }))
                        );
                      case 38:
                      ...
                      case 51:
                        ...
                        if (((b = c.status), !be.has(b))) {
                          e.next = 61;
                          break;
                        }
                        if (
                          (M(
                            (w = c.headers.get("Location")),
                        ...
                        throw (c.headers.set("Location", w), c);
                      case 60:
                        return e.abrupt("return", {
                          type: z.redirect,
                          status: b,
                      ...
                      case 81:
                        return e.abrupt("return", { type: z.data, data: c });
                      case 82:
                      case "end":
                        return e.stop();
                    }
      ...
      function Ue(e, t, n, r) {
        var a = e.createURL(Ke(t)).toString(),
          o = { signal: n };
      ...
      function Be(e, t, n, r, a) {
        ...
        return (
          n.forEach(function (n, c) {
            var f = t[c].route.id;
            if (
              (M(!Je(n), "Cannot handle redirect results in processLoaderData"),
              Xe(n))
            ) {
              var d = He(e, f),
                p = n.error;
              r && ((p = Object.values(r)[0]), (r = void 0)),
                ...
                (i[f] = void 0),
                u || ((u = !0), (o = he(n.error) ? n.error.status : 500)),
      ...
      function $e(e, t, n, r, a, o, i, l) {
        for (
          var u = Be(t, n, r, a, l), s = u.loaderData, c = u.errors, f = 0;
          f < o.length;
          f++
        ) {
          var d = o[f],
          ...
          if (!v || !v.signal.aborted)
            if (Xe(m)) {
              var y = He(e.matches, null == h ? void 0 : h.route.id);
              (c && c[y.route.id]) ||
                (c = O({}, c, _({}, y.route.id, m.error))),
                e.fetchers.delete(p);
            } else if (Je(m)) M(!1, "Unhandled fetcher revalidation redirect");
            else if (Ge(m)) M(!1, "Unhandled fetcher deferred data");
            else {
              var g = ht(m.data);
              e.fetchers.set(p, g);
            }
      ...
      function Qe(e, t) {
        ...
        return (
          ...
          new pe(e || 500, l, new Error(u), !0)
        );
      }
      function qe(e) {
        for (var t = e.length - 1; t >= 0; t--) {
          var n = e[t];
          if (Je(n)) return { result: n, idx: t };
        }
      }
      function Ke(e) {
        return I(O({}, "string" === typeof e ? A(e) : e, { hash: "" }));
      }
      function Ye(e, t) {
        return (
          e.pathname === t.pathname &&
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 11:
                      return (
                        (e.prev = 11),
                        (e.t0 = e.catch(7)),
                        e.abrupt("return", { type: z.error, error: e.t0 })
                      );
                    case 14:
                      return e.abrupt("return", {
                        type: z.data,
      ...
      function ut(e, t) {
        ...
        if (e[e.length - 1].route.index && lt(n || "")) return e[e.length - 1];
        var r = ie(e);
        return r[r.length - 1];
      }
      function st(e) {
      ...
      var kt = e.createContext({ outlet: null, matches: [], isDataRoute: !1 });
      var xt = e.createContext(null);
      function St() {
        return null != e.useContext(wt);
      }
      function Et() {
        return St() || M(!1), e.useContext(wt).location;
      }
      function Ct(t) {
        e.useContext(bt).static || e.useLayoutEffect(t);
      }
      function _t() {
        return e.useContext(kt).isDataRoute
          ? (function () {
              var t = Ft(Mt.UseNavigateStable).router,
                n = It(jt.UseNavigateStable),
                r = e.useRef(!1);
              return (
                Ct(function () {
                  r.current = !0;
                  ...
                  function (e, a) {
                    void 0 === a && (a = {}),
                      r.current &&
                        ("number" === typeof e
                          ? t.navigate(e)
                          : t.navigate(e, vt({ fromRouteId: n }, a)));
                  },
                  [t, n],
                )
              );
                ...
                e.useCallback(
                  function (e, n) {
                    if ((void 0 === n && (n = {}), u.current))
                      if ("number" !== typeof e) {
                        var o = le(e, JSON.parse(l), i, "path" === n.relative);
                        null == t &&
                          "/" !== r &&
                          (o.pathname =
                            "/" === o.pathname ? r : ue([r, o.pathname])),
      ...
      function Lt(t, n) {
        ...
        return e.useMemo(
          function () {
            return le(t, JSON.parse(i), o, "path" === r);
          },
          [t, i, o, r],
        );
      }
      function Rt(t, n, r) {
        St() || M(!1);
        var a,
          i = e.useContext(bt).navigator,
          l = e.useContext(kt).matches,
          u = l[l.length - 1],
          s = u ? u.params : {},
        ...
        var h = a.pathname || "/",
          v = H(t, { pathname: "/" === c ? h : h.slice(c.length) || "/" });
        var m = Dt(
          v &&
            v.map(function (e) {
      ...
      function Tt() {
        var t = (function () {
            var t,
              n = e.useContext(xt),
              r = Ut(jt.UseRouteError),
              a = It(jt.UseRouteError);
            if (n) return n;
      ...
      var Nt = e.createElement(Tt, null),
        Ot = (function (t) {
          g(r, t);
          var n = x(r);
          function r(e) {
      ...
      function zt(t) {
        ...
        return (
          ...
          e.createElement(kt.Provider, { value: n }, a)
        );
      }
      function Dt(t, n, r) {
        var a;
        ...
        if (null != l) {
          ...
          u >= 0 || M(!1), (i = i.slice(0, Math.min(i.length, u + 1)));
        }
      ...
      function At(t) {
        return (function (t) {
          var n = e.useContext(kt).outlet;
          return n ? e.createElement(Pt.Provider, { value: t }, n) : n;
        })(t.context);
      }
      function Bt(t) {
        var n = t.basename,
        ...
        return null == _
          ...
          : e.createElement(
              bt.Provider,
              { value: h },
              e.createElement(wt.Provider, { children: i, value: _ }),
            );
      }
      var $t = (function (e) {
          return (
      ...
      function Kt() {
        ...
        return t && t.errors && (t = Vt({}, t, { errors: Yt(t.errors) })), t;
      }
      function Yt(e) {
        if (!e) return null;
        for (var t = {}, n = 0, r = Object.entries(e); n < r.length; n++) {
          ...
          if (i && "RouteErrorResponse" === i.__type)
            t[o] = new pe(i.status, i.statusText, i.data, !0 === i.internal);
      ...
      var Gt = e.createContext({ isTransitioning: !1 });
      var Xt = e.createContext(new Map());
      var Jt = t.startTransition;
      var Zt = m(function e() {
        var t = this;
        d(this, e),
          (this.status = "pending"),
      ...
      function en(t) {
        var n = t.fallbackElement,
          r = t.router,
          a = t.future,
          o = f(e.useState(r.state), 2),
          i = o[0],
          l = o[1],
          u = f(e.useState(), 2),
          s = u[0],
          c = u[1],
          d = f(e.useState({ isTransitioning: !1 }), 2),
          p = d[0],
          h = d[1],
          v = f(e.useState(), 2),
          m = v[0],
            ...
            function () {
              if (m && s && r.window) {
                ...
                n.finished.finally(function () {
                  y(void 0), w(void 0), c(void 0), h({ isTransitioning: !1 });
                }),
                  w(n);
              }
            },
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    i.initialized
                      ? e.createElement(tn, { routes: r.routes, state: i })
                      : n,
                  ),
                ),
              ),
      ...
      function tn(e) {
        return Rt(e.routes, void 0, e.state);
      }
      var nn =
          "undefined" !== typeof window &&
          "undefined" !== typeof window.document &&
        ...
        an = e.forwardRef(function (t, n) {
          var r,
            ...
            p = Qt(t, qt),
            h = e.useContext(bt).basename,
            v = !1;
          if ("string" === typeof c && rn.test(c) && ((r = c), nn))
            try {
      ...
      var cn = ["title", "titleId"];
      var fn = e.forwardRef(function (t, n) {
          var r = t.title,
            a = t.titleId,
            o = sn(t, cn);
          return e.createElement(
      ...
      function vn() {
        return (0, a.jsxs)("div", {
          ...
          children: [
            (0, a.jsx)(un, { title: "Home", href: "/" }),
            (0, a.jsx)(un, { title: "About", href: "/about" }),
            (0, a.jsx)(un, { title: "Projects", href: "/projects" }),
            (0, a.jsx)(un, { title: "Contact", href: "/contact" }),
          ],
        });
      }
      var mn = function (e) {
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            (0, a.jsx)(hn, { title: "Home", href: "/", onClose: t }),
            (0, a.jsx)(hn, { title: "About", href: "/about", onClose: t }),
            (0, a.jsx)(hn, {
              title: "Projects",
              href: "/projects",
              onClose: t,
            }),
            (0, a.jsx)(hn, { title: "Contact", href: "/contact", onClose: t }),
          ],
        });
      };
      function yn() {
        var t = f(e.useState(!1), 2),
          n = t[0],
          r = t[1],
          o = function () {
              ...
              (0, a.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, a.jsx)("button", {
                    ...
                    children: n
                      ? (0, a.jsx)(fn, { className: "h-6 w-6", strokeWidth: 2 })
                      : (0, a.jsx)(pn, {
                          className: "h-6 w-6",
                          strokeWidth: 2,
                        }),
      ...
      var _n = function () {
          var e = (function (e, t) {
            ...
            var n;
          })([{ element: (0, a.jsx)(bn, {}), children: Cn }]);
          return (0, a.jsx)("div", {
            className: "bg-background h-screen",
            children: (0, a.jsx)(en, { router: e }),
          });
        },
        Pn = function (e) {
          e &&
...
//# sourceMappingURL=main.ded2c0c4.js.map
